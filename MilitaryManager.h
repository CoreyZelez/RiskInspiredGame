...
public:
	...
	void addArmyReinforcements(double reinforcements);
	void addArmyReserves(double reserves);

	// Returns percentage of troops generated by estates which are to reinforce existing armies.
	float getFleetReinforcementRate() const;
	void addFleetReinforcements(double reinforcements);
	void addFleetReserves(double reserves);
