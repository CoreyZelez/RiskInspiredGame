...
EstateAllocator::EstateAllocator(Player &ruler, PlayerEstateManager &rulerEstateManager, VassalManager &vassalManager)
	: ruler(ruler), rulerEstateManager(rulerEstateManager), vassalManager(vassalManager)
{
}

Player& EstateAllocator::allocate(Estate &estate)
{
